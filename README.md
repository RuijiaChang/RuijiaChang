...
🎓 MEng in Electrical & Computer Engineering @ UIUC  
💼 AI/ML Engineer & Data Scientist  
🔍 Building LLM agents, RAG systems, and data-driven ML applications

---

## 🔍 Interests

- LLM Agents, RAG, Tool Calling, and Multi-Agent Workflows
- Applied Machine Learning for real-world decision systems
- Data Science, Evaluation, and Experimentation
...
**Languages:** Python, SQL, JavaScript, C/C++, Java, Bash  

**LLM & Agent Systems:** LangGraph, LangChain, RAG, Tool Calling, MCP, OpenAI API, Multi-Agent Workflows  

**Retrieval & Data Systems:** PostgreSQL, SQLite, Redis, ChromaDB, FAISS, BM25, BGE Embeddings  

**Machine Learning:** PyTorch, TensorFlow, scikit-learn, XGBoost, LightGBM, nnU-Net  

**Backend & Deployment:** FastAPI, Docker, Linux, AWS, CUDA, FP16  

**Data Engineering:** Pandas, NumPy, Spark, Hadoop/Hive  
